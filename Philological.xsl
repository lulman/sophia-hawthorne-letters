 ...
 <!--  <xsl:template match="body">
   ...
   <xsl:template match="pb">
      <div class="pagebreak">
        ...
        (<a><xsl:attribute name="HREF">http://people.cohums.ohio-state.edu/ulman1/Sophia_Hawthorne_Letters/zoom.cfm?file=<xsl:value-of select="@mmid"/>.jpg</xsl:attribute><xsl:attribute name="target">top</xsl:attribute>click to open page image in a new window</a>)]<br/>
      </div>
      <!-- Removed by -->
      <!-- <HR width="90%"/> -->
   </xsl:template>
